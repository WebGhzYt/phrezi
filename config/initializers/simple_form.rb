# Copied from: https://gist.github.com/tokenvolt/6599141
inputs = %w[
  ...
  TextInput
  PriorityInput
].map{|i| "SimpleForm::Inputs::#{i}".constantize }
inputs << DatePickerInput
...
SimpleForm.setup do |config|
  ...
  config.wrappers :icon, tag: 'div', class: 'form-group', error_class: 'has-error', defaults: { input_html: { class: 'form-control input-lg' } } do |b|
    b.use :html5
    b.use :placeholder
    b.use :label
    b.wrapper tag: 'div', class: 'input-group' do |group|
      group.wrapper :addon, tag: 'span', class: 'input-group-addon' do |addon|
        addon.wrapper :icon, tag: 'span', class: 'glyphicon' do end
      end
      group.use :input
    end
  ...
  config.wrappers :bootstrap3_horizontal, tag: 'div', class: 'form-group', error_class: 'has-error',
    ...
    b.wrapper :control, tag: 'div', class: 'col-sm-9' do |input_block|
