...
describe EmployeesController do
  ...
  let(:valid_attributes) { { "employee_role" => "" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved employee as @employee" do
        ...
        post :create, {:employee => { "employee_role" => "invalid value" }}, valid_session
        assigns(:employee).should be_a_new(Employee)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested employee" do
        ...
        Employee.any_instance.should_receive(:update).with({ "employee_role" => "" })
        put :update, {:id => employee.to_param, :employee => { "employee_role" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the employee as @employee" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Employee.any_instance.stub(:save).and_return(false)
        put :update, {:id => employee.to_param, :employee => { "employee_role" => "invalid value" }}, valid_session
        assigns(:employee).should eq(employee)
      end
